...
public class StreamingMain {
  ...
  /* NaissanceReciever reciever=new NaissanceReciever(inputPath,javaStreamingContext);
        ...
        javaDStream.foreachRDD(
                rdd->{
                    ...
                    Mapper m=new Mapper();
                    //Dataset<ActeDeNaissance> dsa = m.apply(acteDeNaissanceDataset);
        ...
        NaissanceReciever reciever=new NaissanceReciever(inputPath,jsc);
        JavaDStream<ActeDeNaissance> javaDStream = reciever.get();
        javaDStream.foreachRDD(
                rdd->{
                    long o = System.currentTimeMillis();
